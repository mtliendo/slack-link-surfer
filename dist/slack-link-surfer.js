(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('buffer'), require('string_decoder'), require('stream'), require('util'), require('http'), require('url'), require('https'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['buffer', 'string_decoder', 'stream', 'util', 'http', 'url', 'https', 'zlib'], factory) :
  (global.slackLinkSurfer = factory(global.buffer,global.string_decoder,global.stream,global.util,global.http,global.url,global.https,global.zlib));
}(this, (function (buffer,string_decoder,stream,util,http,url,https,zlib) { 'use strict';
  ...
  var require$$0 = ( shiftjis$1 && shiftjis ) || shiftjis$1;

  var require$$1 = ( eucjp$1 && eucjp ) || eucjp$1;
